...
while($row = $result->fetch_assoc()) {
  ...
  while($row2 = $result2->fetch_assoc()) {
    ...
    echo "<tr><td>".$ingredientName."</td><td>".$typeOfFood."</td><td>" .$ingredientQuantity."</td><td>" .$ingredientUnit."</td><td><input type='submit' name='removeFromList' value='Remove from list'></td></tr>";
  }
}
